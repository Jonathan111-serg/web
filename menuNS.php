...
?>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li>
      <div class="">
          <p style="color:white">Horas de servicio: <?php echo($sesion->getTiempoString(1)); ?></p>
          <?php 
          if ($sesion->servicio) {
            # code...
    ...
    ?>
        ...
        <li>
          <a href="https://docs.google.com/document/d/1MlxCRbEsaogf2HrRmIby5di5jEFMVMDbM4uwdenNaG0">
