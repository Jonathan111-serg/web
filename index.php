...
.myButton2:active {
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright SantaLifeRP 2020/21 Licencia de uso para SantaLifeRP;  <a href="http://localhost/spainrp.es/index.html">SantaLifeRP Web</a>.</strong> Todos los Derechos Reservados.
  </footer>
